...
<body>
	...
	<form action="<%=request.getContextPath()%>/daejeon/book_DaejeonDBInsert.jsp" method="post" class="main">
	...
	결제방법 : <input type="radio" name="B_pay" value="on" checked="checked">온라인 결제<br>
			<input type="radio" name="B_pay" value="off">현장 결제  <br>
